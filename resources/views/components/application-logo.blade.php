<svg viewBox="0 0 220 56" xmlns="http://www.w3.org/2000/svg" {{ $attributes }} role="img" aria-labelledby="fsrp-logo-title fsrp-logo-desc">
    ...
    <path d="M39 16C51.15 16 61 25.85 61 38H51C51 31.37 45.63 26 39 26V16Z" fill="#F97316" />
    <text x="75" y="26" fill="white" font-family="Inter, Arial, sans-serif" font-size="18" font-weight="800" letter-spacing="1">FSRP</text>
    <text x="75" y="42" fill="#D1FAE5" font-family="Inter, Arial, sans-serif" font-size="9" font-weight="600">Food System Resilience Program</text>
</svg>
