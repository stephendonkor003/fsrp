                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('fsrp_component_id') is-invalid @enderror"
                                ...
                                @foreach ($fsrpComponents as $component)
                                    <option value="{{ $component->id }}" @selected(old('fsrp_component_id') == $component->id)>
                                ...
                                @foreach ($fsrpComponents as $component)
                                    @foreach ($component->subcomponents as $subcomponent)
                                        <option value="{{ $subcomponent->id }}"
                                            ...
                                            @selected(old('fsrp_subcomponent_id') == $subcomponent->id)>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('ppsd_reference') is-invalid @enderror"
                                id="ppsd_reference" name="ppsd_reference" value="{{ old('ppsd_reference') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('step_plan_id') is-invalid @enderror"
                                id="step_plan_id" name="step_plan_id" value="{{ old('step_plan_id') }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('step_plan_status') is-invalid @enderror"
                                ...
                                @foreach ([
                                    ...
                                    <option value="{{ $value }}" @selected(old('step_plan_status', 'not_uploaded') === $value)>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control @error('step_last_uploaded_at') is-invalid @enderror"
                                ...
                                value="{{ old('step_last_uploaded_at') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('prior_review_required') is-invalid @enderror"
                                ...
                                <option value="0" @selected(old('prior_review_required', '0') === '0')>No</option>
                                <option value="1" @selected(old('prior_review_required') === '1')>Yes</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('world_bank_no_objection_status') is-invalid @enderror"
                                ...
                                @foreach ([
                                    ...
                                    <option value="{{ $value }}" @selected(old('world_bank_no_objection_status', 'pending') === $value)>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control @error('world_bank_no_objection_date') is-invalid @enderror"
                                ...
                                value="{{ old('world_bank_no_objection_date') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('procurement_risk_level') is-invalid @enderror"
                                ...
                                @foreach (['low' => 'Low', 'moderate' => 'Moderate', 'substantial' => 'Substantial', 'high' => 'High'] as $value => $label)
                                    <option value="{{ $value }}" @selected(old('procurement_risk_level') === $value)>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('contract_log_reference') is-invalid @enderror"
                                ...
                                value="{{ old('contract_log_reference') }}" placeholder="Contract logbook or record reference">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control @error('procurement_record_notes') is-invalid @enderror"
                                ...
                                placeholder="STEP upload, prior review, or record-keeping notes">{{ old('procurement_record_notes') }}</textarea>
