    ...
    <main class="nxl-container">
        <div class="nxl-content">
            <div class="page-header d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="mb-1">Edit Treaty</h4>
                    <p class="text-muted mb-0">Update treaty details and metadata.</p>
                </div>
                <a href="{{ route('settings.au.treaties.show', $treaty->id) }}" class="btn btn-outline-secondary">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <form action="{{ route('settings.au.treaties.update', $treaty->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        @include('au-master-data.treaties._form', ['treaty' => $treaty])

                        <div class="mt-4 d-flex justify-content-between">
                            <a href="{{ route('settings.au.treaties.show', $treaty->id) }}" class="btn btn-light">Cancel</a>
                            <button type="submit" class="btn btn-primary">
                                <i class="feather-save me-1"></i> Update Treaty
                            </button>
                        </div>
                    </form>
                </div>
