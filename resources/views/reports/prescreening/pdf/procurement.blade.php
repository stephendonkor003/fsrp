...
<head>
    <meta charset="utf-8">
    <title>Prescreening Procurement Report</title>
    <style>
...
<body>
    <div class="header">
        <div class="title">{{ config('app.name') }} — Prescreening Procurement Report</div>
        <div class="meta">
            Procurement: {{ $procurement->title ?? '—' }} ({{ $procurement->reference_no ?? '—' }}) |
    ...
    <div class="section">
        ...
        <table>
            ...
            @empty
                <tr>
                    <td colspan="5">No criteria evaluations found.</td>
                </tr>
            @endforelse
        </table>
    </div>
