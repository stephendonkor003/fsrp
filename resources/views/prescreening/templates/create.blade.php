...
@section('content')
    <div class="nxl-container">
        <div class="page-header d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1">Create Prescreening Template</h4>
                <p class="text-muted mb-0">
                    Build prescreening sections and the yes/no items under each section.
                </p>
            </div>
        ...
        <form method="POST" action="{{ route('prescreening.templates.store') }}" id="prescreeningTemplateForm">
            @csrf
        ...
        (() => {
            ...
            if (oldPayload && typeof oldPayload === 'string') {
                try {
                    ...
                    // Ignore invalid old payload and fall back to a blank builder.
                }
            }
