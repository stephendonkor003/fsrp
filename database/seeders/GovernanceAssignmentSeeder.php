    ...
    public function run(): void
    {
        ...
        $assignments = [
            [
                ...
                'node' => 'FSRP Regional Coordination Unit',
                'role_title' => 'Program Administrator',
                'is_primary' => true,
            ],
            [
                'email' => 'finance.manager@example.com',
                'node' => 'Member State PIU - Eastern Africa',
            ...
            [
                ...
                'node' => 'Food Security and Resilience Component',
            ...
            [
                ...
                'node' => 'Regional Implementation Partner',
                'role_title' => 'Prescreening Evaluator',
                'is_primary' => true,
            ],
            [
                'email' => 'evaluator@example.com',
                'node' => 'Climate-Smart Agriculture Component',
